...
const TestimonalAboutus = () => {
  ...
  const CreateCard = ({ card }) => (
    <div className="p-4 rounded-lg mx-4 bg-[#18191B] shadow hover:shadow-lg hover:bg-[#273548] transition-all duration-200 w-72 shrink-0">
        ...
        <div className="w-full md:w-1/2 flex justify-center">
          <div className="flex gap-6 flex-col justify-center items-start">
            ...
            <div className="w-full">
              <h1 className="text-left text-xl sm:text-2xl md:text-5xl font-bold leading-snug md:leading-[1.3]">
                Craft unique identities that stand out
              </h1>
            </div>
          </div>
        </div>
...
export default TestimonalAboutus;
